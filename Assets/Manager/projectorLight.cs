...
public class projectorLight : MonoBehaviour
{
    ...
    */
    ...
    void Update ()
    {
        ...
        //transform.position = new Vector3(transform.position.x, (levels[5]*beatMultiplier), (levels[0]*beatMultiplier));
        transform.position = new Vector3(transform.position.x, transform.position.y, (levels[0]*beatMultiplier));

        GetComponent<Light>().innerSpotAngle = 1+meanLevels[0]*beatMultiplier;

        Debug.Log(1+meanLevels[0]*beatMultiplier);
